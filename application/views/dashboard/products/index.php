                                        ...
                                        <div class="col-md-12">
                                            <?php foreach($bulks as $key=>$bulk){?>
                                                <div class="tr-flex" style="gap: 10px;">
                                                    <label for="pq<?=$key?>">
                                                        <?=lang('Qty')?>
                                                        <input id="pq<?=$key?>" type="text" value="<?=$bulk->qty?>" name="product_prices[<?=$key?>][qty]" class="form-control" disabled>
                                                    </label>
                                                    <label for="pp<?=$key?>">
                                                        <?=lang('Price')?>
                                                        <input id="pp<?=$key?>" type="text" value="" name="product_prices[<?=$key?>][price]" class="form-control">
                                                    </label>
                                                </div>
                                            <?php }?>
                                        </div>
                                                ...
                                                <select multiple="multiple" id="my-select" name="related_products[]">
                                                    <?php foreach($products as $product) { ?>
                                                        <option value='<?= $product->id ?>'>
                                                            <?= trim($product->{'title'.get_language_for_admin(true)}) ?>
                                                        </option>
                                                    <?php } ?>
                                                </select>
                                            <?php } ?>
                    ...
                    <div class="table-scrollable">
                        <table class="table table-bordered table-striped table-hover tree">
                            ...
                            <tbody>
                                    ...
                                    <tr style="height: 51px;">
                                        ...
                                        <td class="align-middle">
                                            ...
                                            <label class="mt-checkbox mt-checkbox-outline">
                                                <input data-col="isShown" data-table="<?=$table?>" type="checkbox" <?= $cmod ?> value="<?= $item->id ?>"
                                ...
                                <?php endforeach; ?>
                            <?php } else { ?>
                                <?php $ids = array_map( function($item){ return $item->category_id; }, $products);?>
                                <?php $ids = array_unique($ids); sort($ids); ?>
